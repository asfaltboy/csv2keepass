...
Allows you to convert csv from either LastPass export or KeePass 2.0's "export to csv" to a KeePass XML import.
...
=head2 USAGE
	...
	python lastpass2keepass.py exportedCSVFile
...
I<Forked from the excellent lastpass2keepass>, I<Anirudh Joshi>, L<https://github.com/anirudhjoshi/lastpass2keepass>.
